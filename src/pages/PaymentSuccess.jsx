...
const PaymentSuccess = () => {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": `${serviceName} Payment Confirmation`,
    "url": "https://fatepath.me/payment-success",
    "description": `Payment confirmation and next steps for the ${serviceName} delivered by FatePath in English for clients across the United States and worldwide.`,
    "inLanguage": "en-US",
    "isPartOf": {
      "@type": "WebSite",
      "name": "FatePath",
    ...
    "audience": {
      "@type": "Audience",
      "name": "Clients seeking BaZi and Chinese astrology services in the United States and abroad"
    }
  }
  ...
  return (
    <>
      <SEO
        title={`${serviceName} Payment Confirmation | FatePath`}
        description={`Thank you for your purchase. Your ${serviceName} will be delivered within ${getDeliveryTime(service)} with English-language support for clients in the United States and worldwide.`}
        keywords="payment confirmation, fatepath order complete, bazi reading usa, chinese astrology service, talisman delivery"
        canonical="https://fatepath.me/payment-success"
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-mystic-300 mb-6 text-lg">
              Thank you for your payment. Your {serviceName} order has been confirmed.
            </p>
